...
function M.config()
  vim.api.nvim_create_autocmd('LspAttach', {
    ...
    callback = function(event)
      ...
      map('gd', sm.pick('lsp_definitions'), '[G]oto [D]efinition')
      map('gr', sm.pick('lsp_references'), '[G]oto [R]eferences')
      map('gI', sm.pick('lsp_implementations'), '[G]oto [I]mplementation')
      map('<leader>D', sm.pick('lsp_type_definitions'), 'Type [D]efinition')
      map('<leader>ls', sm.pick('lsp_symbols'), '[D]ocument [S]ymbols')
      map('<leader>lw', sm.pick('lsp_workspace_symbols'), '[W]orkspace Symbols')
